...
router.post(
	...
	body("confirmPassword")
	 ...
	 .custom(
		(value, {req}) => {
			if(value !== req.body.password) throw new Error("Password and confirmPassword must be the same");
			return true;
		}),
	body("displayName")
...
router.put(
	...
	body("confirmNewPassword")
	 ...
	 .custom(
		(value, {req}) => {
			if(value !== req.body.newPassword) throw new Error("newPassword and confirmNewPassword must be the same");
			return true;
		}),
	requestHandler.validate,
